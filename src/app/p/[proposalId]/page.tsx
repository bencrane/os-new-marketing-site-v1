      ...
      >
        ...
        <Section number="06" title="The Offer">
          <p>
            ...
            ready to make. The difference between a 1% response rate and a 10%
            response rate is almost always the offer.
          </p>
          <p>
              ...
              <div key={category.title}>
                ...
                <Accordion>
                  {category.faqs.map((faq, i) => (
                    <AccordionItem key={i} value={i}>
                      <AccordionTrigger className="text-base text-foreground font-medium">
                        {faq.q}
                      </AccordionTrigger>
                      <AccordionContent>
...
function TAMDashboard({ client }: { client: string }) {
